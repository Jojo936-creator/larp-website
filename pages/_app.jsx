        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{fontSize: 16, color: '#444', marginBottom: 18}}>
              This site collects access and usage data exclusively for authentication and security purposes. No data is shared with third parties for commercial purposes.<br/><br/>
              For the full policy see <a href="https://amber-mozelle-72.tiiny.site" target="_blank" rel="noopener noreferrer" style={{color:'#1a73e8', textDecoration:'underline'}}>Privacy Policy</a>.
            </div>
